...
Se estudian las necesidades del usuario y los requisitos del sistema.

2. Diseño

Se define la estructura del software y su funcionamiento.

3. Implementación

Se escribe el código utilizando un lenguaje de programación.

4. Pruebas

Se verifican los errores y se comprueba que el software funciona correctamente.

5. Mantenimiento

Se corrigen errores y se añaden mejoras tras la entrega del software.