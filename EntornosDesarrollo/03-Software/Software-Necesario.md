...
- Acepta las opciones por defecto (incluye Git Bash automáticamente).
...
- Abre **VS Code** y ve a **Extensiones.**
...
- Escribe “Seleccionar perfil de terminal predeterminado”.
...
- Ve a Control de código fuente (icono de ramas).

- **Inicia sesión** en GitHub desde VS Code (aparecerá un aviso).

- Clona un repositorio o crea uno nuevo.
